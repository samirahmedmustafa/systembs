...
public class LocationController {
	...
	public ResponseEntity<Location> updateById(@RequestBody Location location) {
		return new ResponseEntity<Location>(locationService.update(location), HttpStatusCode.valueOf(200));
	}
